				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='paid') }}">الفواتير المدفوعة</a></li>
							@endcan
							@can('الفواتير الغير المدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='nonpaid') }}">الفواتير غير المدفوعة</a></li>
							@endcan
							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='partial') }}">الفواتير المدفوعة جزئيا</a></li>
							@endcan
							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='archive') }}">ارشيف</a></li>
							@endcan
						</ul>
					</li>
					@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_report') }}">التقارير الفواتير</a></li>
							@endcan
							@can('تقرير العملاء')
								
								<li><a class="slide-item" href="{{ url('/' . $page='costumer') }}">تقارير العملاء</a></li>
							@endcan
						</ul>
					</li>
					@endcan
