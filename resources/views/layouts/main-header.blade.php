								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a class="badge badge-pill badge-warning mr-auto my-auto float-left" href="{{url('readall')}}"><span >قراءة الكل</span></a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notification_count">عدد الاشعارات الغير مقرؤة : {{Auth()->user()->unreadNotifications->count()}}</p>
									</div>
									<div class="main-notification-list Notification-scroll" id="notification">
										...
										<a class="d-flex p-3 border-bottom" href="{{url('invoicesdetails')}}/{{$notification->data['id']}}">
											...
											<div class="mr-3">
												...
												<div class="notification-subtext"> created : {{$notification->created_at}}</div>
											</div>
											<div class="mr-auto" >
