                    ...
                    <form action="{{ url('status_update',['id'=>$invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="يرجي ادخال رقم الفاتورة" value="{{ $invoices['invoice-number'] }}" readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input class="form-control" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoices['invoice-date'] }}" readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" readonly onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')" >
                                    <!--placeholder-->
                                    <option value=" {{ $invoices->section->id }}" aria-readonly="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()" aria-readonly="true">
                                    <!--placeholder-->
                                    <option value=" {{ $invoices['rate-vat'] }}">
                                        {{ $invoices['rate-vat'] }}
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" name="Value_VAT"
                                    value="{{ $invoices['value-vat'] }}" readonly>
                            </div>
